...
/**
 * Script pour générer une vidéo TikTok avec un nom de fichier unique
 * Usage: node generate-video.js [options]
 * Options:
...
// Fonction pour générer un nom de fichier unique pour job
const generateUniqueFilename = () => {
  ...
  return `job-${day}-${month}-${hours}-${minutes}.mp4`;
};
...
// Construire la commande Remotion
let command = `npx remotion render Main "${outputPath}"`;
...
console.log(`🎬 Génération de la vidéo TikTok...`);
